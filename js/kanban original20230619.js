...
$(document).ready(function () {
  ...
  // $("#pane-2").show(); //Library 보여주기
  $("#pane-1").show(); //Show specific tab content Stella 보여주기
...
const adjective5conceptE = new Array("any", "bad", "basic", "big", "certain", "clear", "cool", "dead", "deep", "difficult", "dirty", "easy", "famous", "fantastic", "favorite", "fine", "good", "great", "important", "little", "new", "nice", "same", "small", "some", "true", "wrong");
...
function function1705() {
  ...
  switch (chooseNumbers1) {
    ...
    case 2: // Opinions What S 동사 be동사(is/was) 형용사
      kWord = PRONOUN_PERSONAL_SUBJECTIVE_PLURAL_2K[valueNumberA] + " " + VERB_SENTENCE_FORM_3_PAST_2K[valueNumberAA] + " 것은 " + RELATIVES_ADJECTIVE_2K[valueNumberBB];
    ...
    case 3: // Uncertainty/Confusion , Expressions of Surprise/Disbelief , Curiosity/Interest
      ...
      break;
    case 4: // There is What S 동사 be동사(is/was) 형용사
      kWord = PRONOUN_PERSONAL_SUBJECTIVE_PLURAL_K[valueNumberA] + " " + VERB_SENTENCE_FORM_3_PAST_2K[valueNumberAA] + " 것은 " + RELATIVES_ADJECTIVE_2K[valueNumberBB];
      eWord = "What " + PRONOUN_PERSONAL_SUBJECTIVE_SMALL_E[valueNumberA] + " " + VERB_SENTENCE_FORM_3_PAST_E[valueNumberAA] + " is " + RELATIVES_ADJECTIVE_E[valueNumberBB];
      break;
