...
document.getElementById('openTabCLS101').addEventListener('click', function () {
  // Hide the tabCLS-container
  var container = document.getElementById('tabCLS-container');
  if (container) {
    container.style.display = 'none';
  }

  // Show the tabCLS-101
  var tabCLS101 = document.getElementById('tabCLS-101');
  if (tabCLS101) {
    tabCLS101.style.display = 'block';
  }
});


// Function to handle the opening and closing of Day divs
function toggleDay(dayNumber) {
  // Loop through all day divs and hide them
  for (let i = 1; i <= 11; i++) {
    let dayDiv = document.getElementById(`drillDay${i}`);
    if (dayDiv) {
  ...
  let selectedDayDiv = document.getElementById(`drillDay${dayNumber}`);
  if (selectedDayDiv) {
    selectedDayDiv.style.display = 'block';
  }
}

// Adding event listeners to D buttons
window.onload = function () {
  for (let i = 1; i <= 11; i++) {
    let button = document.querySelector(`.openDay${i}`);
    if (button) {
...
function getDescriptionPageNumber1() {
  ...
  document.getElementById('divRandom').innerHTML = "";
...
function getSmallTalkPageNumber(pageNumber) {
  ...
  document.getElementById('audioSetting').innerHTML = z;
  let y = '<img src="../images/grammar_image/glPage/smallTalk' + pageNumber + '.png' + '" alt="GrammarPage">';
  document.getElementById('glAudioCard').innerHTML = y;
};
...
const day_E = new Array("0 What's your name? ", "1 How old are you?", "2 How are you?", "3 How's the weather?", "4 What time is it?", "5 What day is it today? (What day was it yesterday?)", "6 What's the date? 12/1", "7 When is your birthday?", "8 What season is it?", "9 What's your favorite season?", "10 Do you like _______? ( color / food / subjects / season )", "11 What do you like?", "12 Do you have ______? ( things / pens / pets / hobbies ...)", "13 What do you have?", "14 Where is your _____? ( bag / pencil / book / friend / mom / dad / homework ... )", "15 Where do you live?", "16 What is this?", "17 Can you _____? (swim / run / jump / dive / talk / slide )", "18 What can you do?", "19 What do you do in the morning? ", "20 What do you do in the afternoon? ", "21 What do you do in the evening?", "22 What are you doing?", "23 What are you wearing?", "24 What is your friend wearing? / doing?", "25 What did you do yesterday?", "26 What did you do last weekend?", "27 Where did you go last weekend?", "28 How was your weekend?", "29 What will you do after CLS?", "30 What will you do this weekend?", "31 Which one is smaller? ( big / strong / fast / weak )", "32 Which one is the smallest?", "33 How many __________ do you have ? ( ears / eyes / legs / fingers ... )", "34 How many seasons are there in a year?", "35 Where do you live?", "36 What time do you get up?", "37 Is there __________ in your room? ( a desk / chair / window ... )", "38 How big is your family?", "39 How many books do you read a week?", "40 What’s your favorite subject? Why?", "41 Do you have any hobbies?", "42 Who is your favorite teacher? Why do you like her/him?", "43 Who is your best friend?", "44 Where do you want to go on the weekend?", "45 Where do you want to go on a vacation?", "46 What do you want to do on a vacation?", "47 Have you ever been to another country?", "48 What do you like to do in your free time?", "49 If you could live in any country, which would you pick and why?", "50 When are you happy?");
...
const day1_E = new Array("0 What's your name? ", "1 How old are you?", "2 How are you?", "3 How's the weather?", "4 What time is it?", "5 What day is it today? (What day was it yesterday?)", "6 What's the date? 12/1", "7 When is your birthday?", "8 What season is it?", "9 What's your favorite season?", "10 Do you like _______? ( color / food / subjects / season )");
...
const day2_E = new Array("11 What do you like?", "12 Do you have ______? ( things / pens / pets / hobbies ...)", "13 What do you have?", "14 Where is your _____? ( bag / pencil / book / friend / mom / dad / homework ... )", "15 Where do you live?", "16 What is this?", "17 Can you _____? (swim / run / jump / dive / talk / slide )", "18 What can you do?", "19 What do you do in the morning? ", "20 What do you do in the afternoon?");
...
const day3_E = new Array("21 What do you do in the evening?", "22 What are you doing?", "23 What are you wearing?", "24 What is your friend wearing? / doing?", "25 What did you do yesterday?", "26 What did you do last weekend?", "27 Where did you go last weekend?", "28 How was your weekend?", "29 What will you do after CLS?", "30 What will you do this weekend?");
...
const day4_E = new Array("31 Which one is smaller? ( big / strong / fast / weak )", "32 Which one is the smallest?", "33 How many __________ do you have ? ( ears / eyes / legs / fingers ... )", "34 How many seasons are there in a year?", "35 Where do you live?", "36 What time do you get up?", "37 Is there __________ in your room? ( a desk / chair / window ... )", "38 How big is your family?", "39 How many books do you read a week?", "40 What’s your favorite subject? Why?");
...
const day5_E = new Array("41 Do you have any hobbies?", "42 Who is your favorite teacher? Why do you like her/him?", "43 Who is your best friend?", "44 Where do you want to go on the weekend?", "45 Where do you want to go on a vacation?", "46 What do you want to do on a vacation?", "47 Have you ever been to another country?", "48 What do you like to do in your free time?", "49 If you could live in any country, which would you pick and why?", "50 When are you happy?");
...
const PASSIVE_TENSE_PROGRESSIVE_PRESENT_K = new Array("행동되고 있다", "더해져 있다", "조언받고 있다", "동의되고 있다", "대답되고 있다", "도착되고 있다", "요청되고 있다", "구워지고 있다", "되고 있다", "되고 있다", "시작되고 있다", "믿어지고 있다", "물리고 있다", "막아지고 있다", "빌려지고 있다", "깨뜨려지고 있다", "가져와지고 있다", "닦아지고 있다", "만들어지고 있다", "타지고 있다", "사지고 있다", "전화되고 있다", "보살펴지고 있다", "휴대되고 있다", "잡아지고 있다", "변경되고 있다", "확인되고 있다", "선택되고 있다");
...
const JET34LESSON23_K = new Array("누가", "무엇", "어디서", "언제", "왜", "어떻게", "어느, 어느 것", "누구의, 누구의 것");
const JET34LESSON23_E = new Array("who", "what", "where", "when", "why", "how", "which", "whose");
function jet34lesson23() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON23_K.length);
  let kWord = JET34LESSON23_K[valueNumber];
  let eWord = JET34LESSON23_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON24_K = new Array("일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일");
const JET34LESSON24_E = new Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
function jet34lesson24() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON24_K.length);
  let kWord = JET34LESSON24_K[valueNumber];
  let eWord = JET34LESSON24_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON25_K = new Array("1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월");
const JET34LESSON25_E = new Array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");

function jet34lesson25() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON25_K.length);
  let kWord = JET34LESSON25_K[valueNumber];
  let eWord = JET34LESSON25_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON26_K = new Array("봄", "여름", "가을", "가을","겨울");
const JET34LESSON26_E = new Array("Spring", "Summer", "Fall","Autumn", "Winter");

function jet34lesson26() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON26_K.length);
  let kWord = JET34LESSON26_K[valueNumber];
  let eWord = JET34LESSON26_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON27_K = new Array("초", "분", "시", "새벽", "아침", "지난", "지난", "~까지");
const JET34LESSON27_E = new Array("second", "minute", "hour", "dawn", "morning", "after", "past", "to");

function jet34lesson27() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON27_K.length);
  let kWord = JET34LESSON27_K[valueNumber];
  let eWord = JET34LESSON27_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON28_K = new Array("낮", "오후", "저녁", "자정", "밤");
const JET34LESSON28_E = new Array("noon", "afternoon", "evening", "midnight", "night");

function jet34lesson28() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON28_K.length);
  let kWord = JET34LESSON28_K[valueNumber];
  let eWord = JET34LESSON28_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON29_K = new Array("날", "어제", "오늘", "내일");
const JET34LESSON29_E = new Array("day", "yesterday", "today", "tomorrow");

function jet34lesson29() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON29_K.length);
  let kWord = JET34LESSON29_K[valueNumber];
  let eWord = JET34LESSON29_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
const JET34LESSON30_K = new Array("1:15", "2:30", "4:45", "6:10", "7:50", "9:25", "10:05", "12:00", "8:40", "5:35", "11:55", "3:20", "2:45", "4:30", "7:05", "10:50", "1:40", "6:15", "9:00", "11:35");
const JET34LESSON30_E = new Array("quarter past one - 'quarter'는 15분을 의미하며, 1시에서 15분이 지난 시간입니다.",
"half past two - 'half'는 30분을 의미합니다. 2시에서 30분 지난 시간입니다.",
"quarter to five - 'quarter to'는 다음 시간(5시)까지 15분 남은 시간입니다.",
"ten past six - 6시에서 10분이 지난 시간입니다.",
"ten to eight - 8시까지 10분 남은 시간입니다.",
"twenty-five past nine - 9시에서 25분이 지난 시간입니다.",
"five past ten - 10시에서 5분이 지난 시간입니다.",
"twelve o'clock - 정각 12시입니다. 정각일 때는 'o'clock'을 붙여 읽습니다.",
"twenty to nine - 9시까지 20분 남은 시간입니다.",
"twenty-five to six - 6시까지 25분 남은 시간입니다.",
"five to twelve - 12시까지 5분 남은 시간입니다.",
"twenty past three - 3시에서 20분이 지난 시간입니다.",
"quarter to three - 3시까지 15분 남은 시간입니다.",
"half past four - 4시에서 30분이 지난 시간입니다.",
"five past seven - 7시에서 5분이 지난 시간입니다.",
"ten to eleven - 11시까지 10분 남은 시간입니다.",
"twenty to two - 2시까지 20분 남은 시간입니다.",
"quarter past six - 6시에서 15분이 지난 시간입니다.",
"nine o'clock - 정각 9시입니다.",
"twenty-five to twelve - 12시까지 25분 남은 시간입니다.");

function jet34lesson30() {
  let valueNumber = Math.floor(Math.random() * JET34LESSON30_K.length);
  let kWord = JET34LESSON30_K[valueNumber];
  let eWord = JET34LESSON30_E[valueNumber];
  document.getElementById("divRandom").innerText = kWord;
  document.getElementById("divRandom2").innerText = eWord;
  let date = new Date();
  let dateStamp = date.getFullYear() + "" + (date.getMonth() + 1) + "" + date.getDate() + "" + date.getHours() + "" + date.getMinutes() + "" + date.getSeconds();
...
SUBJUNCTIVE_MIXED_K = new Array("- (과거) ~했더라면, \n (현재) ~할 텐데");
SUBJUNCTIVE_MIXED_E = new Array("If S had p.p.,\n S 우슈쿠마 동사원형");
//function1803b SUBJUNCTIVE_AUXILIARY_WOULD_K
function function1803b() {
  let valueNumber = Math.floor(Math.random() * VERB_SENTENCE_FORM_1_E.length);
  let valueNumber1 = Math.floor(Math.random() * VERB_GENERAL_PAST_ALL_K.length);
...
function function2999() {
  let chosenNumbers = Math.floor(Math.random() * 26) + 1;
  console.log(chosenNumbers);
  switch (chosenNumbers) {
    case 1:
      function0110();
